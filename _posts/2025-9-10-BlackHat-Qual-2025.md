...
We can craft an XML request that sets `IsAdmin=true` by abusing Go’s XML parsing behavior, as described in this blog post: [Unexpected security footguns in Go’s parsers](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/):
